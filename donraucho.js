...
const PRODUCTS = [
  ...
  { img: 'img/productos/carrusel/licores/donjulioa.webp',     name: 'Don Julio',      sub: 'Tequila' },
  { img: 'img/productos/carrusel/licores/donjuliob.webp',     name: 'Don Julio',      sub: 'Reposado' },
  { img: 'img/productos/carrusel/licores/josecuervoa.webp',   name: 'José Cuervo',    sub: 'Especial' },
  { img: 'img/productos/carrusel/licores/josecuervob.webp',   name: 'José Cuervo',    sub: 'Tradicional' },
  { img: 'img/productos/carrusel/licores/absolut.webp',       name: 'Absolut',        sub: 'Vodka' },
  { img: 'img/productos/carrusel/licores/blackberry.webp',    name: 'Blackberry',     sub: 'Licor' },
