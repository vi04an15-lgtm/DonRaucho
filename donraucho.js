/* ─── PRODUCTS ────────────────────────────────────────── */
const PRODUCTS = [
  { img: 'img/productos/jackdaniels.webp',                                    name: "Jack Daniel's",   sub: 'Old No. 7' },
  { img: 'img/productos/dalmore3.webp',                                       name: 'The Dalmore',     sub: '18 Years' },
  { img: 'img/productos/bluelabel.webp',                                      name: 'Johnnie Walker',  sub: 'Blue Label' },
  { img: 'img/productos/carrusel/licores/mistral_barrica.jpg',                name: 'Mistral Nobel',   sub: 'Barrica Tostada' },
  { img: 'img/productos/carrusel/licores/mistral_clasico.jpg',                name: 'Mistral Nobel',   sub: 'Clásico' },
  { img: 'img/productos/carrusel/licores/mistral_apple.jpg',                  name: 'Mistral Nobel',   sub: 'Apple' },
  { img: 'img/productos/carrusel/licores/mistral_honey.jpg',                  name: 'Mistral Nobel',   sub: 'Honey' },
  { img: 'img/productos/carrusel/licores/mistral_fire.jpg',                   name: 'Mistral Nobel',   sub: 'Fire' },
  { img: 'img/productos/carrusel/licores/mistral_cristalino.jpg',             name: 'Mistral Nobel',   sub: 'Cristalino' },
  { img: 'img/productos/carrusel/licores/jack_black.jpg',                     name: "Jack Daniel's",   sub: 'No. 7' },
  { img: 'img/productos/carrusel/licores/jack_honey.jpg',                     name: "Jack Daniel's",   sub: 'Honey' },
  { img: 'img/productos/carrusel/licores/jack_apple.jpg',                     name: "Jack Daniel's",   sub: 'Apple' },
  { img: 'img/productos/carrusel/licores/jack_fire.jpg',                      name: "Jack Daniel's",   sub: 'Fire' },
  { img: 'img/productos/carrusel/licores/altodelcarmen_negra.jpg',            name: 'Alto del Carmen', sub: 'Etiqueta Negra' },
  { img: 'img/productos/carrusel/licores/altodelcarmen_blanca.jpg',           name: 'Alto del Carmen', sub: 'Etiqueta Blanca' },
  { img: 'img/productos/carrusel/licores/altodelcarmen_transparente.jpg',     name: 'Alto del Carmen', sub: 'Transparente' },
];
